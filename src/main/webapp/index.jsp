...
<jsp:useBean id="entries" class="slamach.weblab2.beans.EntriesBean" scope="session" />
        ...
        <section class="main-container__item_left-column__item content-section content-section_graph">
          ...
          <span class="content-section__header__text">
            ...
            <div class="content-container result-graph_container">
                <object type="image/svg+xml" data="img/result-graph.svg"><img src="img/result-graph.png" width="219" height="219" alt="График"></object>
            </div>
        </section>
